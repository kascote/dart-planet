...
class ClearErrorsCmd extends BaseCommand {
  ClearErrorsCmd() {
    argParser
  ...
  final name = 'clear';
  @override
  final description = 'clear feed errors and activate';
  ...
  Future<int> run() async {
    ...
    if (updateAll) {
      return runWithPlanet((planet) => planet.clearAllFeedErrors());
    }

    if (handle != null) {
      return runWithPlanet((planet) => planet.clearFeedErrors(handle));
    }
